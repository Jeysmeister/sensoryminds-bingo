...
export default function Home() {
  ...
  // Animation variants for sliding out to the left
  ...
  return (
    <div className="flex w-screen overflow-hidden">
      <AnimatePresence>
        ...
        {activeSection === 2 && (
          <motion.div className="w-screen h-screen flex flex-col justify-center items-center relative" variants={slideInVariant} initial="hidden" animate="visible" exit="slideOut">
            <Header />
