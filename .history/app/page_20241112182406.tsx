  ...
  return (
    <div className="flex w-screen overflow-hidden">
      ...
      <motion.div
        ...
        initial="initial"
        animate={`${(activeSection === 0 || activeSection === 2) && "slideOut"}`}
      ...
      <motion.div className="w-screen h-screen flex flex-col justify-center items-center relative" initial="initial" animate={activeSection === 2 && "visible"} variants={slideInVariant}>
        <Header />
