    ...
    <div className="flex w-screen overflow-hidden">
      ...
      <div className="cursor-pointer">
        <div className="w-screen h-screen flex justify-center items-center text-white bg-black flex-col gap-4">
          ...
          <div className="text-xl font-bold text-left w-full">1. Players must decide on the consequence when a player loses.</div>
          <div className="text-xl font-bold text-left">2. Players must click on the boxes they've done.</div>
