...
const BingoCard = () => {
  ...
  return (
    <div className="border border-gray-300 p-4 pt-0">
      <div className="flex w-full justify-center items-center py-4 text-xl font-extrabold rounded-xl">NEVER HAVE I BINGO</div>
      <div className="max-w-[800px] max-h-[800px] grid grid-cols-5 gap-2 p-4 border border-gray-300 rounded-lg">
        {grid.map((item, index) => (
