...
export default function Home() {
  ...
  return (
    <div className="flex w-screen overflow-hidden">
      ...
      <div className="cursor-pointer">
        <div className="w-screen h-screen flex justify-center items-center text-white bg-black flex-col gap-4">
          <div className="text-4xl font-bold">RULES</div>
          <div className="text-xl font-bold">1. Players must click on the boxes they've done.</div>
          ...
          <div className="text-xl font-bold">4. A player loses if they fill a row, column, or diagonal.</div>
          <div className="text-sm">(Click to continue...)</div>
        </div>
      </div>
