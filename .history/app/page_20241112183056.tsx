...
export default function Home() {
  ...
  const slideInVariant = {
    ...
    visible: { x: 0, opacity: 1, width: 0, transition: { duration: 1 } },
  };
  ...
  return (
    <div className="flex w-screen overflow-hidden">
      <motion.div
        ...
        initial="default"
        animate={`${activeSection === 1 ? "initial" : activeSection === 2 && "initial"}`}
        exit="slideOut"
      ...
      <motion.div
        ...
        initial="initial"
        animate={activeSection === 1 ? "visible" : activeSection === 2 && "initial"}
        exit="slideOut"
        variants={slideInVariant}
      >
